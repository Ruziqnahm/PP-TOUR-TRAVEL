...
export default function TambahPaketPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0fdf4] via-[#f9fafb] to-[#f0fdf4]">
      <AdminSidebar activePage="paket" />
      
      <div className="ml-[256px] p-[40px]">
        <div className="max-w-[1200px] mx-auto">
          {/* Main Form Container */}
          <div className="bg-white rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden">
            <ModalHeader title="Tambah Paket" onClose={handleClose} />
